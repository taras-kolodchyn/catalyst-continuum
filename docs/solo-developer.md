...
workflow paths, review commands, preflight command, issue-sync command, and draft PR evidence, and
it opens the recorded draft PR directly when publication evidence exists. This is easier than
