...
chmod +x "$FAKES_DIR/create-github-issue-session.sh" "$FAKES_DIR/run-dev-task.sh" "$FAKES_DIR/sync-github-issue-status.sh"
...
./scripts/run-github-issue-workflow.sh \
  ...
  --pr-url "https://github.com/smartit/github-issue-workflow-smoke/pull/7" \
