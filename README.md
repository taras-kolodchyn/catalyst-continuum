...
handoff evidence, or lost stable focus in the agent panel or GitHub Issue Workbench. On first run
it installs the pinned Playwright package and matching Chromium browser binary under
