...
them, session manifest, summary, and issue-sync inspection commands. `github-issue-latest` lists
the selected issue refs and handoff posture for recent workflow directories.
